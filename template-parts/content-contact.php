                    ...
                    <div class="col-12 col-xl-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div>
                            <div class="pb-5">
                                ...
                                <p class="mb-0">RR is a vibrant destination with thrilling water slides, relaxing pools, and serene picnic spots, offering affordable fun for families and friends.</p>
                            </div>
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="contact-add-item rounded bg-light p-4">
                                        ...
                                        <div>
                                            <h4>Address</h4>
                                            <p class="mb-0"><?php echo get_field('address'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="contact-add-item rounded bg-light p-4">
                                        ...
                                        <div>
                                            <h4>Mail Us</h4>
                                            <p class="mb-0"><?php echo get_field('email'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="contact-add-item rounded bg-light p-4">
                                        ...
                                        <div>
                                            <h4>Telephone</h4>
                                            <p class="mb-0"><?php echo get_field('phone_no'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="contact-add-item rounded bg-light p-4">
                                        ...
                                        <div>
                                            <h4><?php echo get_field('email'); ?></h4>
                                            <p class="mb-0"><?php echo get_field('phone_no'); ?></p>
                                        </div>
                                    </div>
                                </div>
